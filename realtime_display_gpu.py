...
def save_data_from_files(isTest=False):
    if isTest:
        folder_path = "/home/yyc/chenxi/CRNN_for_smart_bed/dataset/for_test/"
        file_names = os.listdir("/home/yyc/chenxi/CRNN_for_smart_bed/dataset/for_test/")
    else:
        folder_path = "/home/yyc/chenxi/CRNN_for_smart_bed/dataset/for_train"
        file_names = os.listdir("/home/yyc/chenxi/CRNN_for_smart_bed/dataset/for_train")
